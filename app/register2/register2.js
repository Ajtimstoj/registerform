...
angular.module('myApp.register2', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/register2', {
            templateUrl: 'register2/register2.html',
            css: 'register2/register2.css',
    ...
    .controller('Register2Controller', function($window, indexedDBDataSvc) {
        var vm = this;
        vm.users = [];
